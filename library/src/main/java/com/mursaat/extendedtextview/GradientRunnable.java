...
public class GradientRunnable implements Runnable {
    ...
    private Point[] getGradientsPoints(int width, int height) {
        ...
        Point secantP1 = new Point((int) (circleCenter.x - width * Math.cos(angleRadian)), (int) (circleCenter.y - width * Math.sin(angleRadian)));
        Point secantP2 = new Point((int) (circleCenter.x + width * Math.cos(angleRadian)), (int) (circleCenter.y + width * Math.sin(angleRadian)));
